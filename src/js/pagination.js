...
export default class Pagination {
  ...
  createPagination() {
    if (this._currentPage > 1) {
      this.markup += `<li class="pagination__item pagination-item--btn decrement"> <svg class="paginate-btn__icon"><use href="./images/sprite.svg#icon-arrow-left"></use></svg></li>`;
    }
    if (this._currentPage > 1) {
